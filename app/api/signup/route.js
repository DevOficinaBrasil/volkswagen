...
export async function POST(req) {
  ...
  const data =
    ...
    "&fantasy_name=" +
    encodeURIComponent(formData.get("fantasy_name")) +
    "&auto_repair_id=" +
    encodeURIComponent(formData.get("auto_repair_id")) +
    "&branch_activity=" +
    encodeURIComponent(formData.get("branch_activity")) +
    "&auto_repair_cep=" +
    encodeURIComponent(formData.get("auto_repair_cep")) +
    "&auto_repair_city=" +
    encodeURIComponent(formData.get("auto_repair_city")) +
    "&auto_repair_phone=" +
    encodeURIComponent(formData.get("auto_repair_phone")) +
    "&auto_repair_state=" +
    encodeURIComponent(formData.get("auto_repair_state")) +
    "&auto_repair_number=" +
    encodeURIComponent(formData.get("auto_repair_number")) +
    "&auto_repair_street=" +
    encodeURIComponent(formData.get("auto_repair_street"));
